...
def benchmark(M, N, K, provider):
    ...
    if provider == 'torch-gpu':
        ...
        ms, min_ms, max_ms = triton.testing.do_bench(lambda: matmul(triton_a, triton_b, triton_c, m_dim, n_dim, k_dim, k_block), rep=1000, quantiles=quantiles, device_type=device)
